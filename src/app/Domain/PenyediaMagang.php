 ...
 * @return string
 */
public function getAlamaPerushaan(): string
{
    return $this->alama_perushaan;
}/**
 * @param string $alama_perushaan
 */
public function setAlamaPerushaan(string $alama_perushaan): void
{
    $this->alama_perushaan = $alama_perushaan;
}/**
 * @return string
 */
