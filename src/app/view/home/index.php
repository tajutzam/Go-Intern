...
<div class="info-smile" style="height: 50% ; background-color:  white;">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-md-center d-sm-flex align-items-sm-center justify-content-sm-center">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            Kami <span style="color: #4356FF ;">Membantumu</span> untuk terhubung
dengan Para Pencari Magang
            </h2>
